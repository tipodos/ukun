...
@section('contenido')
    ...
    <div class="container-fluid pt-5">
        <div class="text-center mb-4">
            <h2 class="section-title px-5"><span class="px-2">Contacta por cualquier consulta</span></h2>
        </div>
        <div class="row px-xl-5">
            ...
            <div class="col-lg-5 mb-5">
                ...
                <p>Si tienes alguna consulta, no dudes en comunicarte con nosotros. Estamos aquí para ayudarte y brindarte la mejor experiencia de compra. Nos encantaría escuchar de ti.</p>
                <div class="d-flex flex-column mb-3">
                    <h5 class="font-weight-semi-bold mb-3">Tienda unica</h5>
                    ...
                    <p class="mb-2"><i class="fa fa-phone-alt text-primary mr-3"></i>987654321</p>
                </div>
            </div>
        </div>
    </div>
