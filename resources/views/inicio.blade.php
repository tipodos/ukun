...
<div id="header-carousel" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active" style="height: 410px;">
                <img class="img-fluid" src="https://mueblescarrusel.weebly.com/uploads/4/6/6/4/46648817/4063623_orig.jpg"
                    alt="Image">
            ...
            <div class="carousel-item" style="height: 410px;">
                <img class="img-fluid"
                    src="https://dcdn.mitiendanube.com/stores/104/421/themes/atlantico/slide-1698787000700-6400765523-6d38787bbdaa55fda993eaf76eeb966e1698787004.jpg?1704340892"
                    alt="Image">
                <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                    <div class="p-3" style="max-width: 700px;">
        ...
        <div class="row px-xl-5 pb-3">
            <div class="col-lg-4 col-md-6 pb-1">
                <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                    ...
                    <a href="" class="cat-img position-relative overflow-hidden mb-3">
                        <img class="img-fluid"
                            src="https://yolodecoro.pe/wp-content/uploads/2021/01/sofa-cama-para-sala.jpg" alt="">
                    </a>
            ...
            <div class="col-lg-4 col-md-6 pb-1">
                <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                    ...
                    <a href="" class="cat-img position-relative overflow-hidden mb-3">
                        <img class="img-fluid"
                            src="https://www.mueblesvalencia.es/11725-large_default/dormitorio-juvenil-moderno-156-tienda-muebles-madrid.jpg"
                            alt="">
                    </a>
